...
window.TepCMS = (() => {
  ...
  const DEFAULT = {
    ...
    sections: {
      ...
      services: { title: 'НАШИ *УСЛУГИ*', subtitle: 'Комплексный монтаж инженерных коммуникаций в частном доме и коттедже — отопление, тёплый пол, водоснабжение, канализация и котельные под ключ в Казани и по Татарстану.', btnText: 'Заказать услугу' },
      products: { title: 'НАШИ *ТОВАРЫ*', subtitle: 'Котлы, радиаторы, насосы, трубы и арматура для систем отопления и водоснабжения — подбор и монтаж под ключ.', btnText: 'Заказать оборудование' },
      gallery:  { title: 'НАШИ *РАБОТЫ*', subtitle: 'Реализованные проекты монтажа отопления, водоснабжения и канализации в частных домах и коттеджах Татарстана.', btnText: '' },
      location: { title: 'КАК НАС *НАЙТИ*' },
      contacts: { title: 'Мы ждём вас!', subtitle: 'Рассчитаем смету на монтаж инженерных систем в вашем доме — Казань, Набережные Челны и вся Республика Татарстан.', formNameLabel: 'Ваше имя', formPhoneLabel: 'Номер телефона', formBtnText: 'Заказать звонок' },
    }
  };
